-- CreateEnum
CREATE TYPE "EPostRole" AS ENUM ('IDLE', 'REJECTED', 'APPROVED');
...
CREATE TABLE "Post" (
    ...
    "status" "EPostRole" NOT NULL DEFAULT 'IDLE',
    "authorId" TEXT NOT NULL,
...
-- AddForeignKey
ALTER TABLE "CategoryGroup" ADD CONSTRAINT "CategoryGroup_authorId_fkey" FOREIGN KEY ("authorId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
