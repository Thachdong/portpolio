...
export const Header: React.FC = () => {
  return (
    <ul className="flex gap-4 items-center border-b border-gray-300 px-2">
      ...
      <li>
        <a className="py-2 inline-block font-medium" href="#about">
          About Me
        </a>
      </li>
      <li className="text-gray-300">|</li>
      <li>
        <a className="py-2 inline-block font-medium" href="#skills">
          Skills
        </a>
      </li>
      <li className="text-gray-300">|</li>
      <li>
        <a className="py-2 inline-block font-medium" href="#projects">
          Projects
        </a>
      </li>
      <li className="text-gray-300">|</li>
